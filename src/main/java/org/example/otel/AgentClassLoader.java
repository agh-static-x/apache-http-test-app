...
public class AgentClassLoader extends URLClassLoader {
  ...
  private static final String AGENT_INITIALIZER_JAR =
      System.getProperty("otel.otel.javaagent.experimental.initializer.jar", "");
  ...
  /**
   * Construct a new otel.AgentClassLoader.
   *
  ...
  public AgentClassLoader(
    ...
    try {
      ...
      System.out.println("URL ADDED: " + internalJarFileName);
